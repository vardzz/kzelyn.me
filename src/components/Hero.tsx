export function Hero() {
  return (
    <section id="hero" className="flex flex-col lg:flex-row w-full lg:w-screen shrink-0 lg:h-screen pt-10 lg:pt-5 px-6 lg:px-40 z-10 relative overflow-hidden lg:overflow-visible">
