export function Hero() {
  return (
    <section id="hero" className="flex flex-col lg:flex-row w-screen shrink-0 h-[100dvh] pt-10 lg:pt-5 px-6 lg:px-40 z-10 relative overflow-y-auto lg:overflow-visible snap-center">
